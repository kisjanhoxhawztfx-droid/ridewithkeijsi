...
export default function MobileBottomNav() {
  ...
  return (
    <nav
      ...
      className="md:hidden fixed left-0 right-0 mx-auto z-50 w-[calc(100%-24px)] max-w-md bg-[#080d18]/95 backdrop-blur-2xl border border-white/20 rounded-2xl shadow-[0_12px_45px_rgba(0,0,0,0.95),0_0_25px_rgba(0,178,254,0.2)] px-2 py-2 pointer-events-auto select-none"
      style={{
