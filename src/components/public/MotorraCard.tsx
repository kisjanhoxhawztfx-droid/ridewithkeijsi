...
export default function MotorraCard({ motorcycle }: MotorraCardProps) {
  ...
  return (
    <div className="group relative rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-b from-[#120d18] via-[#0b0810] to-[#040306] hover:border-pink-500/50 hover:shadow-[0_15px_40px_rgba(236,72,153,0.18)] transition-all duration-300 flex flex-col justify-between">
      ...
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#120d18] via-transparent to-black/30" />
        ...
        <div className="absolute top-3 left-3 right-3 flex items-center justify-between pointer-events-none">
          {motorcycle.status === "SOLD" ? (
            ...
            <span className="px-2.5 py-1 rounded-full bg-gradient-to-r from-pink-500 to-rose-600 text-white font-black text-[10px] tracking-wider uppercase backdrop-blur-md shadow-md font-['Outfit']">
              NË SHITJE
            </span>
          )}
        ...
        <div className="absolute bottom-3 left-3">
          <span className="px-3 py-1 rounded-lg bg-black/90 backdrop-blur-md border border-pink-500/40 text-pink-400 font-black text-xs sm:text-sm font-['Outfit'] shadow-md">
            {formattedPrice}
          </span>
        </div>
      </div>
      ...
      <div className="p-5 sm:p-6 flex flex-col flex-1 justify-between gap-4">
        <div className="space-y-3">
          ...
          {/* Title */}
          <h3 className="text-base sm:text-lg font-extrabold text-white group-hover:text-pink-400 transition-colors leading-snug font-['Outfit'] line-clamp-1">
            {displayTitle}
          </h3>
